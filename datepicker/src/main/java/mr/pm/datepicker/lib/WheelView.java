...
import mr.pm.datepicker.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.datetimeoptionspicker_textsize);//默认大小
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.pickerview_datetimeoptionspicker_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.pickerview_datetimeoptionspicker_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.pickerview_datetimeoptionspicker_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.pickerview_datetimeoptionspicker_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.pickerview_datetimeoptionspicker_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
