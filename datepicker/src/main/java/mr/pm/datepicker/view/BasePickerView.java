...
import mr.pm.datepicker.listener.OnDismissListener;
import mr.pm.datepicker.utils.DateTimeOptionPickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews(int backgroudId) {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_base_datetimeoptionspicker, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.layout_base_datetimeoptionspicker, decorView, false);
    ...
    public Animation getInAnimation() {
        int res = DateTimeOptionPickerViewAnimateUtil.getAnimationResource(this.gravity, true);
        return AnimationUtils.loadAnimation(context, res);
    }

    public Animation getOutAnimation() {
        int res = DateTimeOptionPickerViewAnimateUtil.getAnimationResource(this.gravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }
    ...
    public void createDialog() {
        if (dialogView != null) {
            ...
            mDialog.getWindow().setWindowAnimations(R.style.datetimeoptionspicker_dialogAnim);
