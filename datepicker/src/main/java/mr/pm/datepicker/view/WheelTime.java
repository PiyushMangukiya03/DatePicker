...
import mr.pm.datepicker.adapter.ArrayWheelAdapter;
import mr.pm.datepicker.adapter.NumericWheelAdapter;
import mr.pm.datepicker.chivorn_utils.adapter.MonthAdapter;
import mr.pm.datepicker.lib.WheelView;
import mr.pm.datepicker.listener.OnItemSelectedListener;
import mr.pm.datepicker.utils.ChinaDate;
import mr.pm.datepicker.utils.LunarCalendar;
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        ...
        if (startYear == endYear) {//开始年等于终止年
            ...
            wv_month.setAdapter(new MonthAdapter());
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year != null) {
            ...
            wv_year.setLabel(view.getContext().getString(R.string.datetimeoptionspicker_year));
        }
        if (label_month != null) {
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.datetimeoptionspicker_month));
        }
        if (label_day != null) {
            wv_day.setLabel(label_day);
        } else {
            wv_day.setLabel(view.getContext().getString(R.string.datetimeoptionspicker_day));
        }
        if (label_hours != null) {
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.datetimeoptionspicker_hours));
        }
        if (label_mins != null) {
            wv_mins.setLabel(label_mins);
        } else {
            wv_mins.setLabel(view.getContext().getString(R.string.datetimeoptionspicker_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(R.string.datetimeoptionspicker_seconds));
        }
