...
import mr.pm.datepicker.listener.CustomListener;
import mr.pm.datepicker.view.BasePickerView;
import mr.pm.datepicker.view.WheelTime;
...
public class DateTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.datetimeoptionspicker_time, contentContainer);
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.datetimeoptionspicker_submit) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.datetimeoptionspicker_cancel) : Str_Cancel);
